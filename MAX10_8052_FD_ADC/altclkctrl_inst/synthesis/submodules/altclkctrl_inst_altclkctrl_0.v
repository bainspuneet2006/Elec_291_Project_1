...
module  altclkctrl_inst_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl1_outclk;
endmodule //altclkctrl_inst_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  altclkctrl_inst_altclkctrl_0  (
    ena,
    inclk,
    outclk);
...
`endif
    ...
    altclkctrl_inst_altclkctrl_0_sub  altclkctrl_inst_altclkctrl_0_sub_component (
                .ena (ena),
                .inclk (sub_wire2),
                .outclk (sub_wire0));
